...
class HelpCommand(commands.BaseCommand):
    help_lines = [
        ...
        '*Music commands*',
        '/artist <name> - View information about given artist',
        '/album <name> - View information about given album',
        '/track <name> - View information about given track. *Also gives a preview*',
        'You have to fill in the name of artist, album or track. It doesnt have to be exactly right. I can search :)\n'
        '*Game commands*'
        '/game <source> <name> - Starts a game. You have to specify *source* where you can choose out of [artist, album, track] and name of the given source.',
        '/stop - Stops the game',
